...
func NewGlobalController(blockService services.IBlockService, transactionService services.TransactionService, addressService services.IAddressService, configurationService services.ConfigurationService) GlobalController {
